...
export const English: Messages = {
  ...
  a6: "There are many countries with multiple acceptable names. Some alternate spellings and previous names are accepted, e.g. Burma for Myanmar. As well, acronyms are acceptable for some multi-word countries, e.g. UAE for United Arab Emirates. A country's flag emoji is also an acceptable input method.",
  ...
  Game2: "Enter",
  Game3: "Enter the name (or flag emoji) of any country to make your first guess.",
